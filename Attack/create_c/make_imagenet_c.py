...
class DistortImageFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        save_path = '/home/workstation/code/XAImethods/CAIN/imagenet/val_images10k_attack/' + self.method.__name__ + \
...
def frost(x, severity=1):
    ...
    filename = ['Attack/create_c/frost1.png', 'Attack/create_c/frost2.png', 'Attack/create_c/frost3.png', 'Attack/create_c/frost4.jpg', 'Attack/create_c/frost5.jpg', 'Attack/create_c/frost6.jpg'][idx]
...
def save_distorted(method=gaussian_noise):
    for severity in range(1, 6):
        ...
        distorted_dataset = DistortImageFolder(
            root="/home/workstation/code/XAImethods/CAIN/imagenet/val_images10k/",
